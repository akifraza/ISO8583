 ...
 * @see ISOComponent
 */
public class isoPackager extends ISOBasePackager {
    protected ISOFieldPackager fld[] = {
    /*000*/ new IFA_NUMERIC (  4, "MESSAGE TYPE INDICATOR"),
    /*001*/ new IFA_BITMAP  (128, "BIT MAP"),
    /*002*/ new IFA_NUMERIC ( 18, "PAN - PRIMARY ACCOUNT NUMBER"),
    ...
    /*025*/ new IFA_NUMERIC (  4, "POINT OF SERVICE CONDITION CODE"),
    /*026*/ new IFA_NUMERIC (  4, "POINT OF SERVICE PIN CAPTURE CODE"),
    /*027*/ new IFA_NUMERIC (  1, "AUTHORIZATION IDENTIFICATION RESP LEN"),
    /*028*/ new IFA_NUMERIC (  8, "AMOUNT, TRANSACTION FEE"),
    /*029*/ new IFA_NUMERIC (  8, "AMOUNT, SETTLEMENT FEE"),
    /*030*/ new IFA_NUMERIC ( 24, "AMOUNT, TRANSACTION PROCESSING FEE"),
    /*031*/ new IFA_NUMERIC (  8, "AMOUNT, SETTLEMENT PROCESSING FEE"),
    /*032*/ new IFA_NUMERIC ( 13, "ACQUIRING INSTITUTION IDENT CODE"),
    /*033*/ new IFA_LLNUM   ( 11, "FORWARDING INSTITUTION IDENT CODE"),
    /*034*/ new IFA_LLNUM   ( 69, "PAN EXTENDED"),
    /*035*/ new IFA_NUMERIC ( 29, "TRACK 2 DATA"),
    ...
    /*043*/ new IF_CHAR     ( 99, "CARD ACCEPTOR NAME/LOCATION"),
    ...
    /*053*/ new IFA_NUMERIC ( 18, "SECURITY RELATED CONTROL INFORMATION"),
    /*054*/ new IFA_LLLCHAR (120, "ADDITIONAL AMOUNTS"),
    /*055*/ new IFA_LLLCHAR (999, "RESERVED ISO"),
    /*056*/ new IFA_LLCHAR  ( 35, "RESERVED ISO"),
    ...
    /*060*/ new IFA_LCHAR   (  7, "RESERVED PRIVATE"),
    /*061*/ new IFA_LLLCHAR (999, "RESERVED PRIVATE"),
    /*062*/ new IF_CHAR     ( 30, "RESERVED PRIVATE"),
    /*063*/ new IFA_LLLCHAR (999, "RESERVED PRIVATE"),
    /*064*/ new IFB_BITMAP  ( 16, "MESSAGE AUTHENTICATION CODE FIELD"),
    /*065*/ new IFB_BITMAP  ( 64, "BITMAP, EXTENDED TERTIARY BITMAP"),
    ...
    /*071*/ new IFA_NUMERIC ( 12, "MESSAGE NUMBER"),
    /*072*/ new IFA_LLLCHAR (999, "DATA RECORD (ISO 8583:1993), MESSAGE NUMBER LAST"),
    ...
    /*086*/ new IFA_NUMERIC ( 15, "CREDITS, AMOUNT"),
    /*087*/ new IFA_NUMERIC ( 15, "CREDITS, REVERSAL AMOUNT"),
    /*088*/ new IFA_NUMERIC ( 15, "DEBITS, AMOUNT"),
    /*089*/ new IFA_NUMERIC ( 15, "DEBITS, REVERSAL AMOUNT"),
    /*090*/ new IFA_NUMERIC ( 42, "ORIGINAL DATA ELEMENTS"),
    /*091*/ new IF_CHAR     (  1, "FILE UPDATE CODE"),
    /*092*/ new IFA_NUMERIC (  2, "FILE SECURITY CODE"),
    /*093*/ new IFA_NUMERIC   ( 13, "RESPONSE INDICATOR"),
    /*094*/ new IFA_NUMERIC  ( 13, "SERVICE INDICATOR"),
    /*095*/ new IF_CHAR     ( 32, "REPLACEMENT AMOUNTS"),
    /*096*/ new IF_CHAR     (  8, "MESSAGE SECURITY CODE"),
    /*097*/ new IFA_NUMERIC ( 16, "AMOUNT, NET SETTLEMENT"),
    ...
    /*101*/ new IF_CHAR     ( 17, "FILE NAME"),
    /*102*/ new IF_CHAR  	( 28, "ACCOUNT IDENTIFICATION 1"),
    ...
    /*113*/ new IFA_LLNUM   ( 11, "Authorizing agent institution id code"),
    ...
    /*124*/ new IFA_LLLCHAR (255, "INFO TEXT"),
    /*125*/ new IFA_LLCHAR  ( 50, "Network management information"),
    /*126*/ new IFA_LCHAR   (  6, "Issuer trace id"),
    /*127*/ new IFA_LLLCHAR (999, "RESERVED PRIVATE USE"),
    /*128*/ new IFB_BITMAP  ( 16, "MAC 2"),
        };
    public isoPackager() {
        super();
